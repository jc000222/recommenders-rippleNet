...
class RippleNet(object):
    ...
    def fit(self, n_epoch, batch_size, train_data, ripple_set, show_loss, save_path):
        ...
        for step in range(n_epoch):
            ...
            epoch_save_path = f"{save_path}/model_epoch_{step+1}.ckpt"
            self.save_model(epoch_save_path)

    def predict(self, batch_size, data, ripple_set=None):
    ...
    def recommend_k_items(self, batch_size, data, top_k=10, remove_seen=True, train_data=None):
